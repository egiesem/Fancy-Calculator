                  ...
                  <table class="table tablesorter " id="plain-table">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button v-on:click="submitPostDeleteallmy()" class="btn btn-danger btn-round btn-sm pull-right" type="button">Clear All</button>
                      ...
                      <tr v-for="(post,index) in laravelData.data" :key="post.id">
                        ...
                        <td>
                          <button v-on:click="submitPostDelete1(post.id, index)" class="btn btn-danger btn-round btn-sm pull-right" type="button">Clear</button>
                  ...
                  <table class="table tablesorter " id="plain-table">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button v-on:click="submitPostDeleteall()" class="btn btn-danger btn-round btn-sm pull-right" type="button">Clear All</button>
